    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            ...
            inputs=[
                ...
                io.Float.Input("spectrum_w", display_name="Blend", default=0.05, min=0.0, max=1.0, step=0.01, tooltip="画質と速度のバランスです。W18Stop0/W15F05MS000 は 0.05 を使います。"),
                io.Int.Input("spectrum_warmup_steps", display_name="Warmup", default=18, min=0, max=50, step=1, tooltip="予測を始める前に実測するステップ数です。W18Stop0 は 18、W15F05MS000 は 15 です。"),
